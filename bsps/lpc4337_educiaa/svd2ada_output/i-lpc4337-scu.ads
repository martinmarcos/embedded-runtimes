...
package Interfaces.LPC4337.SCU is
   pragma Preelaborate;
   ...
   subtype SFSP0_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P0
   type SFSP0_Register is record
      --  Select pin function.
      MODE     : SFSP0_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP0_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP0_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP0_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP0_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP0_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP1_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P1
   type SFSP1_Register is record
      --  Select pin function.
      MODE     : SFSP1_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP1_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP1_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP1_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP1_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP1_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP1_17_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSP1_17_RESERVED_Field_1 is Interfaces.LPC4337.UInt22;

   --  Pin configuration register for pins P1_17
   type SFSP1_17_Register is record
      --  Select pin function.
      MODE       : SFSP1_17_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD        : SFSP1_17_ENUM_1 :=
                    Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN       : SFSP1_17_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Reserved
      RESERVED   : SFSP1_17_RESERVED_Field := 16#0#;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  but must be enabled to transfer data from the I/O buffer to the pad.
      EZI        : SFSP1_17_ENUM_3 :=
                    Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF        : SFSP1_17_ENUM_4 :=
                    Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Select drive strength.
      EHD        : SFSP1_17_ENUM_5 :=
                    Interfaces.LPC4337.SCU.Normal_Drive_4_Ma_D;
      --  Reserved
   ...
   subtype SFSP_RESERVED_Field is Interfaces.LPC4337.UInt24;
   ...
   subtype SFSP2_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSP2_RESERVED_Field_1 is Interfaces.LPC4337.UInt22;

   --  Pin configuration register for pins P2
   type SFSP2_Register is record
      --  Select pin function.
      MODE       : SFSP2_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD        : SFSP2_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN       : SFSP2_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Reserved
      ...
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF        : SFSP2_ENUM_4 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Select drive strength.
      EHD        : SFSP2_ENUM_5 := Interfaces.LPC4337.SCU.Normal_Drive_4_Ma_D;
      --  Reserved
   ...
   subtype SFSP2_RESERVED_Field_2 is Interfaces.LPC4337.UInt24;
   ...
   type SFSP2_Register_1 is record
      ...
      EPUN     : SFSP2_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP2_ENUM_6 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP2_ENUM_3 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP2_ENUM_4 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP3_3_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P3
   type SFSP3_3_Register is record
      --  Select pin function.
      MODE     : SFSP3_3_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP3_3_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP3_3_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Slew rate
      EHS      : SFSP3_3_ENUM_3 := Interfaces.LPC4337.SCU.Fast_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP3_3_ENUM_4 :=
                  Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP3_3_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Filter;
      --  Reserved
   ...
   subtype SFSP3_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P3
   type SFSP3_Register is record
      --  Select pin function.
      MODE     : SFSP3_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP3_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP3_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP3_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP3_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP3_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP4_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P4
   type SFSP4_Register is record
      --  Select pin function.
      MODE     : SFSP4_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP4_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP4_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP4_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP4_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP4_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   type SFSP_Register_1 is record
      --  Select pin function.
      MODE     : SFSP5_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP5_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP5_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP5_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP5_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP5_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
      RESERVED : SFSP_RESERVED_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype SFSP6_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P6
   type SFSP6_Register is record
      --  Select pin function.
      MODE     : SFSP6_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP6_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP6_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP6_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP6_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP6_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP8_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins P8
   type SFSP8_Register is record
      --  Select pin function.
      MODE     : SFSP8_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSP8_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSP8_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSP8_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSP8_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSP8_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSP9_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSP9_RESERVED_Field_1 is Interfaces.LPC4337.UInt22;

   --  Pin configuration register for pins P9
   type SFSP9_Register is record
      --  Select pin function
      MODE       : SFSP9_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad
      EPD        : SFSP9_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN       : SFSP9_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Slew rate
      EHS        : SFSP9_ENUM_3 := Interfaces.LPC4337.SCU.Slow;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  but must be enabled to transfer data from the I/O buffer to the pad.
      EZI        : SFSP9_ENUM_4 :=
                    Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      ...
      --  Select drive strength
      EHD        : SFSP9_ENUM_5 := Interfaces.LPC4337.SCU.Standard_Drive_4_Ma;
      --  Reserved
   ...
   subtype SFSPA_0_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PA
   type SFSPA_0_Register is record
      --  Select pin function.
      MODE     : SFSPA_0_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPA_0_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPA_0_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPA_0_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPA_0_ENUM_4 :=
                  Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPA_0_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPA_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSPA_RESERVED_Field_1 is Interfaces.LPC4337.UInt22;

   --  Pin configuration register for pins PA
   type SFSPA_Register is record
      --  Select pin function.
      MODE       : SFSPA_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD        : SFSPA_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN       : SFSPA_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Reserved
      ...
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF        : SFSPA_ENUM_4 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Select drive strength.
      EHD        : SFSPA_ENUM_5 := Interfaces.LPC4337.SCU.Normal_Drive_4_Ma_D;
      --  Reserved
   ...
   subtype SFSPA_4_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PA
   type SFSPA_4_Register is record
      --  Select pin function.
      MODE     : SFSPA_4_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPA_4_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPA_4_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPA_4_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPA_4_ENUM_4 :=
                  Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPA_4_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPB_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PB
   type SFSPB_Register is record
      --  Select pin function.
      MODE     : SFSPB_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPB_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPB_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPB_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPB_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPB_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPC_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PC
   type SFSPC_Register is record
      --  Select pin function.
      MODE     : SFSPC_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPC_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPC_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPC_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPC_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPC_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPD_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PD
   type SFSPD_Register is record
      --  Select pin function.
      MODE     : SFSPD_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPD_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPD_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPD_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPD_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPD_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPE_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PE
   type SFSPE_Register is record
      --  Select pin function.
      MODE     : SFSPE_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPE_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPE_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPE_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPE_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPE_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSPF_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins PF
   type SFSPF_Register is record
      --  Select pin function.
      MODE     : SFSPF_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSPF_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSPF_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Select Slew rate.
      EHS      : SFSPF_ENUM_3 := Interfaces.LPC4337.SCU.Slow_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSPF_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSPF_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Glitch;
      --  Reserved
   ...
   subtype SFSCLK_RESERVED_Field is Interfaces.LPC4337.UInt24;

   --  Pin configuration register for pins CLK
   type SFSCLK_Register is record
      --  Select pin function.
      MODE     : SFSCLK_ENUM := Interfaces.LPC4337.SCU.Function_0_Default;
      --  Enable pull-down resistor at pad.
      EPD      : SFSCLK_ENUM_1 := Interfaces.LPC4337.SCU.Disable_Pull_Down;
      --  Disable pull-up resistor at pad. By default, the pull-up resistor is
      --  enabled at reset.
      EPUN     : SFSCLK_ENUM_2 := Interfaces.LPC4337.SCU.Enable_Pull_Up;
      --  Slew rate
      EHS      : SFSCLK_ENUM_3 := Interfaces.LPC4337.SCU.Fast_Low_Noise_With;
      --  Input buffer enable. The input buffer is disabled by default at reset
      --  and must be enabled for receiving.
      EZI      : SFSCLK_ENUM_4 := Interfaces.LPC4337.SCU.Disable_Input_Buffer;
      --  Input glitch filter. Disable the input glitch filter for clocking
      --  signals higher than 30 MHz.
      ZIF      : SFSCLK_ENUM_5 := Interfaces.LPC4337.SCU.Enable_Input_Filter;
      --  Reserved
   ...
   subtype SFSUSB_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSUSB_RESERVED_Field_1 is Interfaces.LPC4337.UInt26;

   --  Pin configuration register for pins USB1_DM and USB1_DP
   type SFSUSB_Register is record
      --  Differential data input AIP/AIM.
      USB_AIM    : SFSUSB_ENUM := Interfaces.LPC4337.SCU.Going_Low_With_Full;
      --  Control signal for differential input or single input.
      USB_ESEA   : SFSUSB_ENUM_1 := Interfaces.LPC4337.SCU.Single_Input;
      --  Enable pull-down connect.
      USB_EPD    : SFSUSB_ENUM_2 :=
                    Interfaces.LPC4337.SCU.Pull_Down_Disconnect;
      --  Reserved
      RESERVED   : SFSUSB_RESERVED_Field := 16#0#;
      --  Power mode.
      USB_EPWR   : SFSUSB_ENUM_3 :=
                    Interfaces.LPC4337.SCU.Power_Saving_Mode_S;
      --  Enable the vbus_valid signal. This signal is monitored by the USB1
      ...
      USB_VBUS   : SFSUSB_ENUM_4 :=
                    Interfaces.LPC4337.SCU.Vbus_Signal_Low_Or_I;
      --  Reserved
   ...
   type SFSI2C0_ENUM is
     (
      --  50 ns glitch filter
      SFSI2C0_ENUM_50_Ns_Glitch_Filter,
      --  3 ns glitch filter
      SFSI2C0_ENUM_3_Ns_Glitch_Filter)
     with Size => 1;
   for SFSI2C0_ENUM use
     (SFSI2C0_ENUM_50_Ns_Glitch_Filter => 0,
      SFSI2C0_ENUM_3_Ns_Glitch_Filter => 1);

   subtype SFSI2C0_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype SFSI2C0_RESERVED_Field_1 is Interfaces.LPC4337.UInt3;
   ...
   type SFSI2C0_Register is record
      ...
      SCL_ZIF    : SFSI2C0_ENUM_3 :=
                    Interfaces.LPC4337.SCU.Enable_Input_Filter;
      ...
      SDA_EHD    : SFSI2C0_ENUM_1 := Interfaces.LPC4337.SCU.Standardfast_Mode;
      --  Enable the input receiver for the SDA pin. Always write a 1 to this
      --  bit when using the I2C0.
      SDA_EZI    : SFSI2C0_ENUM_2 := Interfaces.LPC4337.SCU.Disabled;
      --  Reserved
   ...
   type ENAIO0_Register is record
      --  Select ADC0_0
      ADC0_0        : ENAIO0_ENUM :=
                       Interfaces.LPC4337.SCU.Digital_Function_Sel;
      --  Select ADC0_1
      ADC0_1        : ENAIO0_ENUM :=
                       Interfaces.LPC4337.SCU.Digital_Function_Sel;
      --  Select ADC0_2
      ...
      ADC0_6        : ENAIO0_ENUM :=
                       Interfaces.LPC4337.SCU.Digital_Function_Sel;
      --  unspecified
      Reserved_7_31 : Interfaces.LPC4337.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type ENAIO2_Register is record
      ...
      DAC           : ENAIO2_ENUM :=
                       Interfaces.LPC4337.SCU.Digital_Function_Sel;
      --  unspecified
      Reserved_1_3  : Interfaces.LPC4337.UInt3 := 16#0#;
      ...
      BG            : ENAIO2_ENUM_1 :=
                       Interfaces.LPC4337.SCU.Digital_Function_Sel;
      --  unspecified
      Reserved_5_31 : Interfaces.LPC4337.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype EMCDELAYCLK_CLK_DELAY_Field is Interfaces.LPC4337.UInt16;
   subtype EMCDELAYCLK_RESERVED_Field is Interfaces.LPC4337.UInt16;
   ...
   subtype SDDELAY_SAMPLE_DELAY_Field is Interfaces.LPC4337.UInt4;
   subtype SDDELAY_RESERVED_Field is Interfaces.LPC4337.UInt4;
   subtype SDDELAY_DRV_DELAY_Field is Interfaces.LPC4337.UInt4;
   subtype SDDELAY_RESERVED_Field_1 is Interfaces.LPC4337.UInt20;
   ...
   subtype PINTSEL0_INTPIN0_Field is Interfaces.LPC4337.UInt5;
   ...
   subtype PINTSEL0_INTPIN1_Field is Interfaces.LPC4337.UInt5;
   subtype PINTSEL0_INTPIN2_Field is Interfaces.LPC4337.UInt5;
   subtype PINTSEL0_INTPIN3_Field is Interfaces.LPC4337.UInt5;
   ...
   type PINTSEL0_Register is record
      ...
      --  Pin interrupt 0: Select the port for the pin number to be selected in
      --  the INTPIN0 bits of this register.
      PORTSEL0 : PINTSEL0_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL1 : PINTSEL0_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL2 : PINTSEL0_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL3 : PINTSEL0_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PINTSEL1_INTPIN4_Field is Interfaces.LPC4337.UInt5;
   ...
   subtype PINTSEL1_INTPIN5_Field is Interfaces.LPC4337.UInt5;
   subtype PINTSEL1_INTPIN6_Field is Interfaces.LPC4337.UInt5;
   subtype PINTSEL1_INTPIN7_Field is Interfaces.LPC4337.UInt5;
   ...
   type PINTSEL1_Register is record
      ...
      --  Pin interrupt 4: Select the port for the pin number to be selected in
      --  the INTPIN4 bits of this register.
      PORTSEL4 : PINTSEL1_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL5 : PINTSEL1_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL6 : PINTSEL1_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
      ...
      PORTSEL7 : PINTSEL1_ENUM := Interfaces.LPC4337.SCU.Gpio_Port_0;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
