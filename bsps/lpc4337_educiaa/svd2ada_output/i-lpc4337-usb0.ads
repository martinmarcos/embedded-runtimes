...
package Interfaces.LPC4337.USB0 is
   pragma Preelaborate;
   ...
   type DCIVERSION_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.LPC4337.UInt16;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype USBCMD_D_RESERVED_Field_3 is Interfaces.LPC4337.Bit;
   subtype USBCMD_D_ITC_Field is Interfaces.LPC4337.Byte;
   subtype USBCMD_D_RESERVED_Field_4 is Interfaces.LPC4337.Byte;

   --  USB command (device mode)
   type USBCMD_D_Register is record
      --  Run/Stop
      RS         : USBCMD_D_ENUM := Interfaces.LPC4337.USB0.Detach;
      ...
      RST        : USBCMD_D_ENUM_1 := Interfaces.LPC4337.USB0.Resetcomplete;
   ...
   type USBCMD_H_Register is record
      --  Run/Stop
      RS         : USBCMD_H_ENUM := Interfaces.LPC4337.USB0.Halt;
      --  Controller reset. Software uses this bit to reset the controller.
      --  This bit is set to zero by the Host/Device Controller when the reset
      --  process is complete. Software cannot terminate the reset process
      --  early by writing a zero to this register.
      RST        : USBCMD_H_ENUM_1 := Interfaces.LPC4337.USB0.Resetcomplete;
      ...
      --  periodic schedule.
      PSE        : USBCMD_H_ENUM_2 :=
                    Interfaces.LPC4337.USB0.Do_Not_Process_The_P;
      --  This bit controls whether the host controller skips processing the
      --  asynchronous schedule.
      ASE        : USBCMD_H_ENUM_3 :=
                    Interfaces.LPC4337.USB0.Do_Not_Process_The_A;
      --  This bit is used as a doorbell by software to tell the host
      --  controller to issue an interrupt the next time it advances
      --  asynchronous schedule.
      IAA        : USBCMD_H_ENUM_4 :=
                    Interfaces.LPC4337.USB0.The_Host_Controller;
      --  Reserved
      ...
      ASPE       : USBCMD_H_ENUM_5 :=
                    Interfaces.LPC4337.USB0.Park_Mode_Is_Disable;
      --  Reserved.
   ...
   subtype USBSTS_D_AAI_Field is Interfaces.LPC4337.Bit;
   ...
   subtype USBSTS_D_RESERVED_Field_4 is Interfaces.LPC4337.UInt12;

   --  USB status (device mode)
   type USBSTS_D_Register is record
      --  USB interrupt
      UI         : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  USB error interrupt
      UEI        : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  Port change detect.
      PCI        : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  Not used in Device mode.
      ...
      --  USB reset received
      URI        : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  SOF received
      SRI        : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  DCSuspend
      SLI        : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      ...
      RESERVED_2 : USBSTS_D_RESERVED_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  NAK interrupt bit
      NAKI       : USBSTS_D_ENUM := Interfaces.LPC4337.USB0.St;
      --  Reserved. Software should only write 0 to reserved bits.
   ...
   type USBSTS_H_Register is record
      --  USB interrupt (USBINT)
      UI         : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  USB error interrupt (USBERRINT)
      UEI        : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  Port change detect.
      PCI        : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  Frame list roll-over
      FRI        : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  Reserved.
      RESERVED   : USBSTS_H_RESERVED_Field := 16#0#;
      --  Interrupt on async advance
      AAI        : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  Not used by the Host controller.
      RESERVED_1 : USBSTS_H_RESERVED_Field := 16#0#;
      --  SOF received
      SRI        : USBSTS_H_ENUM := Interfaces.LPC4337.USB0.St;
      --  Not used by the Host controller.
      RESERVED_2 : USBSTS_H_RESERVED_Field := 16#0#;
      --  Reserved.
      RESERVED_3 : USBSTS_H_RESERVED_Field_1 := 16#0#;
      --  HCHalted
      HCH        : USBSTS_H_ENUM_1 := Interfaces.LPC4337.USB0.Rs;
      --  Reclamation
      RCL        : USBSTS_H_ENUM_2 :=
                    Interfaces.LPC4337.USB0.No_Empty_Asynchronou;
      ...
      PS         : USBSTS_H_ENUM_3 := Interfaces.LPC4337.USB0.Disabled;
   ...
   subtype USBINTR_D_RESERVED_Field_2 is Interfaces.LPC4337.UInt12;
   ...
   type DEVICEADDR_Register is record
      ...
      --  Device address advance
      USBADRA  : DEVICEADDR_ENUM := Interfaces.LPC4337.USB0.Instantaneous;
      --  USB device address
   ...
   subtype ENDPTNAK_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype ENDPTNAKEN_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype PORTSC1_D_RESERVED_Field is Interfaces.LPC4337.Bit;
   subtype PORTSC1_D_PE_Field is Interfaces.LPC4337.Bit;
   subtype PORTSC1_D_PEC_Field is Interfaces.LPC4337.Bit;
   subtype PORTSC1_D_RESERVED_Field_1 is Interfaces.LPC4337.UInt2;
   ...
   subtype PORTSC1_D_RESERVED_Field_4 is Interfaces.LPC4337.UInt4;

   --  Port 1 status/control (device mode)
   type PORTSC1_D_Register is record
      --  Current connect status
      CCS        : PORTSC1_D_ENUM :=
                    Interfaces.LPC4337.USB0.Device_Not_Attached;
      --  Not used in device mode
      ...
      --  one as well.
      FPR        : PORTSC1_D_ENUM_1 := Interfaces.LPC4337.USB0.No_Resume;
      --  Suspend In device mode, this is a read-only status bit .
      SUSP       : PORTSC1_D_ENUM_2 :=
                    Interfaces.LPC4337.USB0.Port_Not_In_Suspend;
      --  Port reset In device mode, this is a read-only status bit. A device
      --  reset from the USB bus is also indicated in the USBSTS register.
      PR         : PORTSC1_D_ENUM_3 :=
                    Interfaces.LPC4337.USB0.Port_Is_Not_In_The_R;
      --  High-speed status This bit is redundant with bits 27:26 (PSPD) in
      --  this register. It is implemented for compatibility reasons.
      HSP        : PORTSC1_D_ENUM_4 := Interfaces.LPC4337.USB0.Not_Highsspeed;
      --  Not used in device mode.
      ...
      --  Port indicator control Writing to this field effects the value of the
      --  USB0_IND[1:0] pins.
      PIC1_0     : PORTSC1_D_ENUM_5 := Interfaces.LPC4337.USB0.Off;
      ...
      PTC3_0     : PORTSC1_D_ENUM_6 :=
                    Interfaces.LPC4337.USB0.Test_Mode_Disable;
      ...
      PHCD       : PORTSC1_D_ENUM_7 := Interfaces.LPC4337.USB0.Enable;
      --  Port force full speed connect
      PFSC       : PORTSC1_D_ENUM_8 := Interfaces.LPC4337.USB0.Anyspeed;
      --  reserved
      RESERVED_5 : PORTSC1_D_RESERVED_Field := 16#0#;
      --  Port speed This register field indicates the speed at which the port
      --  is operating.
      PSPD       : PORTSC1_D_ENUM_9 := Interfaces.LPC4337.USB0.Full_Speed;
      --  Reserved
   ...
   --  port states, see Table 240. The host controller will unconditionally set
   --  this bit to zero when software sets the Force Port Resume bit to zero.
   --  The host controller ignores a write of zero to this bit. If host
   ...
   type PORTSC1_H_Register is record
      ...
      CCS            : PORTSC1_H_ENUM :=
                        Interfaces.LPC4337.USB0.No_Device_Is_Present;
      --  Connect status change Indicates a change has occurred in the port's
      ...
      CSC            : PORTSC1_H_ENUM_1 :=
                        Interfaces.LPC4337.USB0.No_Change_In_Current;
      ...
      PE             : PORTSC1_H_ENUM_2 :=
                        Interfaces.LPC4337.USB0.Port_Disabled;
      ...
      PEC            : PORTSC1_H_ENUM_3 := Interfaces.LPC4337.USB0.No_Change;
      ...
      OCA            : PORTSC1_H_ENUM_4 :=
                        Interfaces.LPC4337.USB0.The_Port_Does_Not_Ha;
      ...
      --  (Port Power bit) is 0.
      FPR            : PORTSC1_H_ENUM_5 := Interfaces.LPC4337.USB0.No_Resume;
      ...
      PR             : PORTSC1_H_ENUM_7 :=
                        Interfaces.LPC4337.USB0.Port_Is_Not_In_The_R;
      --  High-speed status
      HSP            : PORTSC1_H_ENUM_8 := Interfaces.LPC4337.USB0.No_Hispeed;
      ...
      LS             : PORTSC1_H_ENUM_9 := Interfaces.LPC4337.USB0.Se0;
      --  Port power control Host/OTG controller requires port power control
      ...
      PP             : PORTSC1_H_ENUM_10 :=
                        Interfaces.LPC4337.USB0.Port_Power_Off;
      --  Reserved
      RESERVED       : PORTSC1_H_RESERVED_Field := 16#0#;
      --  Port indicator control Writing to this field effects the value of the
      --  pins USB0_IND1 and USB0_IND0.
      PIC1_0         : PORTSC1_H_ENUM_11 :=
                        Interfaces.LPC4337.USB0.Port_Indicators_Are;
      --  Port test control Any value other than 0000 indicates that the port
      --  is operating in test mode. The FORCE_ENABLE_FS and FORCE ENABLE_LS
      --  are extensions to the test mode support specified in the EHCI
      --  specification. Writing the PTC field to any of the
      ...
      WKCN           : PORTSC1_H_ENUM_13 :=
                        Interfaces.LPC4337.USB0.Disables_The_Port_To;
      ...
      PHCD           : PORTSC1_H_ENUM_15 :=
                        Interfaces.LPC4337.USB0.Writing_A_0_Enables;
      --  Port force full speed connect
      PFSC           : PORTSC1_H_ENUM_16 :=
                        Interfaces.LPC4337.USB0.Port_Connects_At_Any;
      --  Reserved
      ...
      PSPD           : PORTSC1_H_ENUM_17 :=
                        Interfaces.LPC4337.USB0.Full_Speed;
      --  unspecified
      Reserved_28_31 : Interfaces.LPC4337.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTGSC_VD_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_VC_Field is Interfaces.LPC4337.Bit;
   ...
   subtype OTGSC_OT_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_DP_Field is Interfaces.LPC4337.Bit;

   --  ID pull-up. This bit provides control over the pull-up resistor.
   type OTGSC_ENUM_1 is
     (
      ...
      Pull_Up_On)
     with Size => 1;
   for OTGSC_ENUM_1 use
     (Pull_Up_Off_The_Id => 0,
      Pull_Up_On => 1);

   subtype OTGSC_HADP_Field is Interfaces.LPC4337.Bit;

   --  Hardware assist B-disconnect to A-connect
   type OTGSC_ENUM_2 is
     (
      --  Disabled.
      Disabled,
     ...
     with Size => 1;
   for OTGSC_ENUM_2 use
     (Disabled => 0,
      Enable_Automatic_B_D => 1);

   --  USB ID
   type OTGSC_ENUM_3 is
     (
      --  A-device
      A_Device,
      --  B-device
      B_Device)
     with Size => 1;
   for OTGSC_ENUM_3 use
     (A_Device => 0,
      B_Device => 1);

   subtype OTGSC_AVV_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_ASV_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSV_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_MS1T_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_DPS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_RESERVED_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_IDIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_AVVIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_ASVIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSVIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSEIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_ms1S_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_DPIS_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_IDIE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_AVVIE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_ASVIE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSVIE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_BSEIE_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_MS1E_Field is Interfaces.LPC4337.Bit;
   subtype OTGSC_DPIE_Field is Interfaces.LPC4337.Bit;
   ...
   type OTGSC_Register is record
      ...
      --  Hardware assist auto_reset
      HAAR       : OTGSC_ENUM := Interfaces.LPC4337.USB0.Disabled;
      ...
      --  ID pull-up. This bit provides control over the pull-up resistor.
      IDPU       : OTGSC_ENUM_1 := Interfaces.LPC4337.USB0.Pull_Up_Off_The_Id;
      --  Hardware assist data pulse Write a 1 to start data pulse sequence.
      HADP       : OTGSC_HADP_Field := 16#0#;
      --  Hardware assist B-disconnect to A-connect
      HABA       : OTGSC_ENUM_2 := Interfaces.LPC4337.USB0.Disabled;
      --  USB ID
      ID         : OTGSC_ENUM_3 := Interfaces.LPC4337.USB0.A_Device;
   ...
   type USBMODE_D_Register is record
      ...
      CM1_0      : USBMODE_D_ENUM := Interfaces.LPC4337.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      --  buffers to match the host microprocessor bus architecture. The bit
      --  fields in the microprocessor interface and the DMA data structures
      ...
      ES         : USBMODE_D_ENUM_1 :=
                    Interfaces.LPC4337.USB0.Little_Endian_First;
      --  Setup Lockout mode In device mode, this bit controls behavior of the
      --  setup lock mechanism. See Section 18.10.8.
      SLOM       : USBMODE_D_ENUM_2 :=
                    Interfaces.LPC4337.USB0.Setup_Lockouts_On;
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_D_ENUM_3 := Interfaces.LPC4337.USB0.Not_Disabled;
      --  Not used in device mode.
   ...
   type USBMODE_H_Register is record
      ...
      --  switch modes, software must reset the controller by writing to the
      --  RESET bit in the USBCMD register before reprogramming this register.
      CM         : USBMODE_H_ENUM := Interfaces.LPC4337.USB0.Idle;
      --  Endian select This bit can change the byte ordering of the transfer
      ...
      --  Stream disable mode The use of this feature substantially limits the
      --  overall USB performance that can be achieved.
      SDIS       : USBMODE_H_ENUM_2 := Interfaces.LPC4337.USB0.Not_Disabled;
      --  VBUS power select
      VBPS       : USBMODE_H_ENUM_3 := Interfaces.LPC4337.USB0.Low;
      --  reserved
   ...
   subtype ENDPTSETUPSTAT_RESERVED_Field is Interfaces.LPC4337.UInt26;
   ...
   subtype ENDPTPRIME_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype ENDPTFLUSH_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype ENDPTSTAT_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype ENDPTCOMPLETE_RESERVED_Field is Interfaces.LPC4337.UInt10;
   ...
   subtype ENDPTCTRL0_RXT1_0_Field is Interfaces.LPC4337.UInt2;
   ...
   subtype ENDPTCTRL0_TXT1_0_Field is Interfaces.LPC4337.UInt2;
   subtype ENDPTCTRL0_TXE_Field is Interfaces.LPC4337.Bit;

   --  Endpoint control 0
   type ENDPTCTRL0_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL0_ENUM := Interfaces.LPC4337.USB0.Endpoint_Ok;
      --  reserved
      ...
      --  Tx endpoint stall
      TXS        : ENDPTCTRL0_ENUM := Interfaces.LPC4337.USB0.Endpoint_Ok;
      --  reserved
   ...
   type ENDPTCTRL_Register is record
      --  Rx endpoint stall
      RXS        : ENDPTCTRL_ENUM :=
                    Interfaces.LPC4337.USB0.Endpoint_Ok_This_Bi;
      --  Reserved
      RESERVED   : ENDPTCTRL_RESERVED_Field := 16#0#;
      --  Endpoint type
      RXT        : ENDPTCTRL_ENUM_1 := Interfaces.LPC4337.USB0.Control;
      --  Reserved
      ...
      RXI        : ENDPTCTRL_ENUM_2 := Interfaces.LPC4337.USB0.Disabled;
      ...
      RXE        : ENDPTCTRL_ENUM_3 :=
                    Interfaces.LPC4337.USB0.Endpoint_Disabled;
      --  reserved
      ...
      --  Tx endpoint type
      TXT1_0     : ENDPTCTRL_ENUM_4 := Interfaces.LPC4337.USB0.Control;
      --  reserved
      ...
      --  endpoint to ignore the data toggle sequence and always accept data
      --  packets regardless of their data PID.
      TXI        : ENDPTCTRL_ENUM_5 := Interfaces.LPC4337.USB0.Enabled;
   ...
   for USB0_Peripheral use record
      ...
      ENDPTCTRL        at 16#1C4# range 0 .. 159;
