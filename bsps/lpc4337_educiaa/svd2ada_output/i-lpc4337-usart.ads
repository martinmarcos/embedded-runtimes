...
package Interfaces.LPC4337.USART is
   pragma Preelaborate;
   ...
   subtype IER_RESERVED_Field is Interfaces.LPC4337.Bit;
   subtype IER_RESERVED_Field_1 is Interfaces.LPC4337.UInt3;
   subtype IER_RESERVED_Field_2 is Interfaces.LPC4337.UInt22;
   ...
   type IER_Register is record
      ...
      RXIE       : IER_ENUM := Interfaces.LPC4337.USART.Disable;
      --  Reserved
      ...
      ABEOINTEN  : IER_ENUM := Interfaces.LPC4337.USART.Disable;
      --  Enables the auto-baud time-out interrupt.
      ABTOINTEN  : IER_ENUM := Interfaces.LPC4337.USART.Disable;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   type FCR_Register is record
      ...
      FIFOEN     : FCR_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Write-only. RX FIFO Reset.
      RXFIFORES  : FCR_ENUM_1 := Interfaces.LPC4337.USART.No_Effect;
      --  Write-only. TX FIFO Reset.
      TXFIFORES  : FCR_ENUM_1 := Interfaces.LPC4337.USART.No_Effect;
      ...
      --  activated.
      RXTRIGLVL  : FCR_ENUM_2 := Interfaces.LPC4337.USART.Level_0;
      --  Write-only. Reserved
   ...
   type LCR_ENUM_1 is
     (
      ...
      LCR_ENUM_2_Stop_Bits_1)
     with Size => 1;
   for LCR_ENUM_1 use
     (LCR_ENUM_1_Stop_Bit => 0,
      LCR_ENUM_2_Stop_Bits_1 => 1);
   ...
   type LCR_Register is record
      --  Word Length Select.
      WLS      : LCR_ENUM :=
                  Interfaces.LPC4337.USART.LCR_ENUM_5_Bit_Character_Leng;
      --  Stop Bit Select.
      SBS      : LCR_ENUM_1 := Interfaces.LPC4337.USART.LCR_ENUM_1_Stop_Bit;
      --  Parity Enable
      PE       : LCR_ENUM_2 := Interfaces.LPC4337.USART.Disable_Parity_Gener;
      --  Parity Select.
      PS       : LCR_ENUM_3 := Interfaces.LPC4337.USART.Odd_Parity;
      --  Break Control.
      BC       : LCR_ENUM_4 := Interfaces.LPC4337.USART.Disabled;
      --  Divisor Latch Access Bit.
      DLAB     : LCR_ENUM_4 := Interfaces.LPC4337.USART.Disabled;
      --  Reserved
   ...
   subtype LSR_RESERVED_Field is Interfaces.LPC4337.UInt23;
   ...
   type ACR_Register is record
      ...
      --  completion.
      START       : ACR_ENUM := Interfaces.LPC4337.USART.Stop;
      --  Auto-baud mode select bit.
      MODE        : ACR_ENUM_1 := Interfaces.LPC4337.USART.Mode_0;
      --  Restart bit.
      AUTORESTART : ACR_ENUM_2 := Interfaces.LPC4337.USART.No_Restart;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
      RESERVED    : ACR_RESERVED_Field := 16#0#;
      --  End of auto-baud interrupt clear bit (write-only).
      ABEOINTCLR  : ACR_ENUM_3 := Interfaces.LPC4337.USART.No_Effect;
      --  Auto-baud time-out interrupt clear bit (write-only).
      ABTOINTCLR  : ACR_ENUM_3 := Interfaces.LPC4337.USART.No_Effect;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype ICR_PULSEDIV_Field is Interfaces.LPC4337.UInt3;
   subtype ICR_RESERVED_Field is Interfaces.LPC4337.UInt26;

   --  IrDA control register (USART3 only)
   type ICR_Register is record
      --  IrDA mode enable.
      IRDAEN     : ICR_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Serial input direction.
      IRDAINV    : ICR_ENUM_1 := Interfaces.LPC4337.USART.Not_Inverted;
      --  IrDA fixed pulse width mode.
      FIXPULSEEN : ICR_ENUM := Interfaces.LPC4337.USART.Disabled;
   ...
   subtype OSR_RESERVED_Field is Interfaces.LPC4337.Bit;
   subtype OSR_OSFRAC_Field is Interfaces.LPC4337.UInt3;
   subtype OSR_OSINT_Field is Interfaces.LPC4337.UInt4;
   subtype OSR_FDINT_Field is Interfaces.LPC4337.UInt7;
   subtype OSR_RESERVED_Field_1 is Interfaces.LPC4337.UInt17;
   ...
   subtype HDEN_RESERVED_Field is Interfaces.LPC4337.UInt31;

   --  Half-duplex enable Register
   type HDEN_Register is record
      --  Half-duplex mode enable
      HDEN     : HDEN_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype SCICTRL_RESERVED_Field is Interfaces.LPC4337.UInt2;
   subtype SCICTRL_TXRETRY_Field is Interfaces.LPC4337.UInt3;
   subtype SCICTRL_GUARDTIME_Field is Interfaces.LPC4337.Byte;
   subtype SCICTRL_RESERVED_Field_1 is Interfaces.LPC4337.UInt16;

   --  Smart card interface control register
   type SCICTRL_Register is record
      --  Smart Card Interface Enable.
      SCIEN      : SCICTRL_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  NACK response disable. Only applicable in T=0.
      NACKDIS    : SCICTRL_ENUM_1 := Interfaces.LPC4337.USART.Enabled;
      --  Protocol selection as defined in the ISO7816-3 standard.
      PROTSEL    : SCICTRL_ENUM_2 := Interfaces.LPC4337.USART.T_Eq_0;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype RS485CTRL_RESERVED_Field is Interfaces.LPC4337.Bit;
   ...
   subtype RS485CTRL_RESERVED_Field_1 is Interfaces.LPC4337.UInt26;
   ...
   type RS485CTRL_Register is record
      --  NMM enable.
      NMMEN      : RS485CTRL_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Receiver enable.
      RXDIS      : RS485CTRL_ENUM_1 := Interfaces.LPC4337.USART.Enabled;
      --  AAD enable
      AADEN      : RS485CTRL_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Reserved.
      RESERVED   : RS485CTRL_RESERVED_Field := 16#0#;
      --  Direction control for DIR pin.
      DCTRL      : RS485CTRL_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Direction control pin polarity. This bit reverses the polarity of the
      --  direction control signal on the DIR pin.
      OINV       : RS485CTRL_ENUM_2 := Interfaces.LPC4337.USART.Low;
      --  Reserved, user software should not write ones to reserved bits. The
      --  value read from a reserved bit is not defined.
   ...
   subtype SYNCCTRL_RESERVED_Field is Interfaces.LPC4337.UInt25;

   --  Synchronous mode control register.
   type SYNCCTRL_Register is record
      --  Enables synchronous mode.
      SYNC     : SYNCCTRL_ENUM := Interfaces.LPC4337.USART.Disabled;
      --  Clock source select.
      CSRC     : SYNCCTRL_ENUM_1 := Interfaces.LPC4337.USART.Slave_Mode;
      --  Edge sampling.
      FES      : SYNCCTRL_ENUM_2 := Interfaces.LPC4337.USART.Rising;
      --  Transmit synchronization bypass in synchronous slave mode.
      TSBYPASS : SYNCCTRL_ENUM_3 := Interfaces.LPC4337.USART.Synchronized_k;
      --  Continuous master clock enable (used only when CSRC is 1)
      CSCEN    : SYNCCTRL_ENUM_4 := Interfaces.LPC4337.USART.On_Character;
      --  Start/stop bits
      SSSDIS   : SYNCCTRL_ENUM_5 := Interfaces.LPC4337.USART.Send;
      --  Continuous clock clear
      CCCLR    : SYNCCTRL_ENUM_6 := Interfaces.LPC4337.USART.Software;
