...
package Interfaces.LPC4337.GPIO_PORT is
   pragma Preelaborate;
   ...
   subtype B_PBYTE_Field is Interfaces.LPC4337.Bit;
   ...
   type B_Register is record
      ...
      --  unspecified
      Reserved_1_7 : Interfaces.LPC4337.UInt7 := 16#0#;
   end record
   ...
   --  Word pin registers port 0 to 5
   type W_Registers is array (0 .. 255) of Interfaces.LPC4337.UInt32
     with Volatile;

   --  DIR_DIRP array element
   subtype DIR_DIRP_Element is Interfaces.LPC4337.Bit;
   ...
   subtype MASK_MASKP_Element is Interfaces.LPC4337.Bit;
   ...
   subtype PIN_PORT_Element is Interfaces.LPC4337.Bit;
   ...
   subtype MPIN_MPORTP_Element is Interfaces.LPC4337.Bit;
   ...
   subtype SET_SETP_Element is Interfaces.LPC4337.Bit;
   ...
   subtype CLR_CLRP_Element is Interfaces.LPC4337.Bit;
   ...
   subtype NOT_NOTP_Element is Interfaces.LPC4337.Bit;
...
end Interfaces.LPC4337.GPIO_PORT;
